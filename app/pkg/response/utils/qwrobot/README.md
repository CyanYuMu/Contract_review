...
```shell
go get -u "gitlab.internal.ops.haiyiai.tech/platform/toolbox/utils/qwrobot"
```
...
```go
requestid.Set("12123123")
log := logger.WithContext(context.Background())
log.ErrorWithNotify("a", "b", "c")
log.InfoWithNotify("normal information")
log.WarnWithNotify("error")
```
